...
.mem-photo{ clear: both; margin: clamp(var(--sp-5), 6vw, var(--sp-7)) 0;
  width: calc(100% + 2 * clamp(0px, 8vw, 130px)); margin-inline: calc(-1 * clamp(0px, 8vw, 130px)); }
...
.mem-diptych{ clear: both; margin: clamp(var(--sp-5), 6vw, var(--sp-7)) 0; display: grid; grid-template-columns: 1fr 1fr;
  gap: clamp(0.5rem, 1.6vw, 1.1rem); width: calc(100% + 2 * clamp(0px, 6vw, 90px)); margin-inline: calc(-1 * clamp(0px, 6vw, 90px)); }
